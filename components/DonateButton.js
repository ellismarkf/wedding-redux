		...
		return (
			<div>
				...
				{locale === 'es' &&
					<form className='donateBtn' action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
						<input type="hidden" name="cmd" value="_s-xclick" />
						<input type="hidden" name="hosted_button_id" value="BYJA96R7X4N8A" />
						<input type="image" src="http://wowmarkandray.com/img/contribute-spanish.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" />
						<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1" />
					</form>}
			</div>
		)
